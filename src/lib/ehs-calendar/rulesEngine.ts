...
const RAW_RULES: LandingRule[] = [
  ...
  { id: "hazbi", name: "Hazardous Waste Biennial Report", category: "filing", month: 3, day: 1, description: "EPA Form 8700-13 A/B for LQGs; due in even-numbered years only (40 CFR 262.41)", citation: "40 CFR 262.41", frequency: "biennial", authority: "EPA", industries: "all", jurisdictions: ["federal"], conditions: ["hazwaste_gen"] },
  { id: "spcc", name: "SPCC Plan 5-Year Review Check", category: "inspection", month: 1, day: 15, description: "Confirm whether the SPCC Plan review and evaluation is due; 40 CFR 112.5 requires review at least once every five years.", citation: "40 CFR 112.5", frequency: "5-year", authority: "EPA", industries: ["manufacturing", "oil_gas", "warehousing"], jurisdictions: ["federal"], conditions: ["hazmat_storage"] },
  ...
  { id: "psm", name: "PSM 3-Year Compliance Audit Check", category: "inspection", month: 1, day: 1, description: "Confirm whether the Process Safety Management compliance audit is due; 29 CFR 1910.119(o) requires an audit at least every three years.", citation: "29 CFR 1910.119(o)", frequency: "3-year", authority: "OSHA", industries: ["manufacturing", "oil_gas", "food_bev"], jurisdictions: ["federal"], conditions: ["psm_rmp"] },
  { id: "rmp", name: "RMP 5-Year Review Check", category: "filing", month: 6, day: 21, description: "Confirm whether Risk Management Plan resubmission is due; 40 CFR 68 requires resubmission at least every five years (or after certain incidents).", citation: "40 CFR 68", frequency: "5-year", authority: "EPA", industries: ["manufacturing", "oil_gas", "food_bev"], jurisdictions: ["federal"], conditions: ["psm_rmp"] },
  ...
  { id: "fk", name: "Forklift Operator Re-Evaluation Check", category: "training", month: 4, day: 1, description: "Confirm whether powered industrial truck operator competency evaluation is due; 29 CFR 1910.178(l) requires re-evaluation at least every three years.", citation: "29 CFR 1910.178(l)", frequency: "3-year", authority: "OSHA", industries: "all", jurisdictions: ["federal"], conditions: ["powered_vehicles"] },
  { id: "cs", name: "Confined Space Entry Training", category: "training", month: 5, day: 1, description: "PRCS program review and refresher training", citation: "29 CFR 1910.146(g)", frequency: "annual", authority: "OSHA", industries: ["manufacturing", "oil_gas", "construction"], jurisdictions: ["federal"], conditions: ["confined_spaces"] },
  { id: "fp", name: "Fall Protection Training", category: "training", month: 2, day: 15, description: "Fall protection training for workers exposed to fall hazards", citation: "29 CFR 1926.503", frequency: "annual", authority: "OSHA", industries: ["construction"], jurisdictions: ["federal"], conditions: ["fall_hazards"] },
  { id: "hcp", name: "Hearing Conservation Program", category: "training", month: 6, day: 1, description: "Annual audiometric testing and training for noise-exposed workers", citation: "29 CFR 1910.95", frequency: "annual", authority: "OSHA", industries: ["manufacturing", "construction", "oil_gas"], jurisdictions: ["federal"], conditions: ["noise_exposure"] },
  ...
  { id: "rad", name: "Radiation Safety Refresher", category: "training", month: 4, day: 15, description: "Annual refresher — dosimetry, ALARA, emergency procedures", citation: "10 CFR 19.12", frequency: "annual", authority: "NRC", industries: ["healthcare"], jurisdictions: ["federal"], conditions: ["radiation"] },
  ...
  { id: "cr", name: "Crane / Hoist Annual Inspection", category: "maintenance", month: 3, day: 1, description: "Periodic inspection of cranes and lifting devices per 29 CFR 1910.179", citation: "29 CFR 1910.179(j)", frequency: "annual", authority: "OSHA", industries: ["manufacturing", "construction", "warehousing"], jurisdictions: ["federal"], conditions: [] },
  ...
  { id: "bl", name: "Boiler / Pressure Vessel Inspection", category: "maintenance", month: 9, day: 1, description: "Periodic boiler and pressure vessel inspection per state and ASME requirements", citation: "ASME / State", frequency: "annual", authority: "State", industries: ["manufacturing", "healthcare", "food_bev"], jurisdictions: ["federal"], conditions: [] },
  ...
  { id: "cap65", name: "Prop 65 Warning Review", category: "reporting", month: 1, day: 31, description: "Review Proposition 65 warnings and signage", citation: "CA HSC §25249.6", frequency: "annual", authority: "OEHHA", industries: "all", jurisdictions: ["CA"], conditions: ["hazmat_storage"] },
  ...
  { id: "txsw", name: "TPDES Stormwater Permit Renewal Check", category: "permit", month: 8, day: 1, description: "Review Multi-Sector General Permit renewal or NOI update requirements", citation: "30 TAC §281", frequency: "permit-cycle", authority: "TCEQ", industries: ["manufacturing", "construction"], jurisdictions: ["TX"], conditions: ["wastewater"] },
  ...
  { id: "nybk", name: "PBS / CBS Registration Renewal", category: "permit", month: 7, day: 1, description: "Petroleum/Chemical Bulk Storage registration renewal", citation: "6 NYCRR §613", frequency: "annual", authority: "NY DEC", industries: ["manufacturing", "oil_gas", "warehousing"], jurisdictions: ["NY"], conditions: ["hazmat_storage"] },
  ...
  { id: "njdpcc", name: "NJ DPCC / DCR Plan Review Check", category: "inspection", month: 1, day: 15, description: "Review Discharge Prevention, Containment, and Countermeasure plan and cleanup/removal plan per N.J.A.C. 7:1E", citation: "N.J.A.C. 7:1E", frequency: "annual", authority: "NJ DEP", industries: ["manufacturing", "oil_gas", "warehousing"], jurisdictions: ["NJ"], conditions: ["hazmat_storage"] },
...
export const RULES: LandingRule[] = RAW_RULES.map((r) => ({
  ...r,
  sourceUrl: r.sourceUrl ?? citationToEcfrUrl(r.citation),
}));
